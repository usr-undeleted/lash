...
<p align="center">
  <img src="https://img.shields.io/badge/version-v3.11.2-blue">
...
1. conveniant built in escape codes such as \f (fill line), \g (git integration), \l (show user distro logo), even more customizable aliases... and much more to come!!  
